...
class JSend {
  ...
  middleware (req, res, next) {
    ...
    /**
     * send error 4xx
     * @param {number|null|undefined} status - status code http request
     * @param {{ message, errors:[{key: string, value: string}]|string[]|string|number|undefined|null }} bodyError -
     * @return void
     */
    ...
    /**
     * send error 5xx
     * @param {number} status - status code http request
     * @param {{ message }} bodyError -
     * @return void
     */
